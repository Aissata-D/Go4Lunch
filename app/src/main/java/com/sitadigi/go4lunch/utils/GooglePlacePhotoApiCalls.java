...
public class GooglePlacePhotoApiCalls {
        ...
        public static void fetchRestaurantPhoto(com.sitadigi.go4lunch.utils.GooglePlacePhotoApiCalls.Callbacks callbacks,
                                                String photoReference,int maxWidth, int maxHeigth,
                                                String key){
            // 2.1 - Create a weak reference to callback (avoid memory leaks)
            final WeakReference<com.sitadigi.go4lunch.utils.GooglePlacePhotoApiCalls.Callbacks> callbacksWeakReference = new WeakReference<com.sitadigi.go4lunch.utils.GooglePlacePhotoApiCalls.Callbacks>(callbacks);
