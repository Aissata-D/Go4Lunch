...
public class UserViewModelTest extends TestCase {
    ...
    public void testGetAllUser() {
        ...
        //Mocking
        when(mockFakeUserRepository.getAllUser()).thenReturn(mutableLiveDataUsersExpected);
        MutableLiveData<List<User>> mutableLiveDataUsersActual = mockFakeUserRepository.getAllUser();
        //assertion
